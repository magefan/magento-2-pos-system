...
## Useful Links
  * [User Guide](https://magefan.com/magento-pos-system/documentation)
  * [Change Log](https://magefan.com/magento-pos-system/change-log)
  * [FAQs](https://magefan.com/magento-pos-system#pattr-faq)
...
This Magento 2 POS system enables you to get the best Magento features and use them to improve your POS experience. At the same time, all data is tracked and stored in the Magento 2 admin panel. Monitor each terminal and store performance, create POS sessions, and track inventory and orders without leaving the backend.
...
This reduces the stress on the cashiers and helps them to handle carts more effectively.
...
You can simply click on the product price in the cart and change it before processing the order. It allows you to avoid any errors if the price has been changed in Magento, but not in your point-of-sale system.
...
You can also create new customers using a handy POS feature. Create customers using address and email and allow them to join a community of your store. 
...
Besides, you can create invoices and refunds directly from POS. Isn’t it what you were looking for?
...
Moreover, you can restock products easily using a barcode scanner and this POS system interface. 
